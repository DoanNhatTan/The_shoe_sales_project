...
public class QLKH extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblCustomer.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã KH", "Họ tên", "Giới tính", "Địa  chỉ", "SĐT", "Email", "Hình"
            }
        ) {
        ...
        tabs.addTab("List_Customer", jPanel3);
...
//        }        // TODO add your handling code here:
    ...
    void setForm(KhachHang kh){
        ...
        rdoMade.setSelected(!kh.isGioiTinh());
        
        if (kh.getHinh()!= null) {
            try {
                lblHinh.setToolTipText(kh.getHinh());
                lblHinh.setIcon(XImage.readAndResize(lblHinh, kh.getHinh()));
    ...
    KhachHang getForm(){
        if(Validation()){
            ...
            kh.setGioiTinh(rdoFemale.isSelected());
    ...
    void fillTable(){
        ...
        try{
            ...
            for(KhachHang kh : list){
                Object[] row = {
                    kh.getMaKH(), kh.getHoTen(), kh.isGioiTinh() ? "NAM" : "NỮ",
                    kh.getDiaChi(), kh.getSDT(),kh.getEmail(),kh.getHinh()
                };
                model.addRow(row);
            }
        }catch(Exception e){
    ...
    void insert(){
        ...
        if(kh == null){
            return;
        }else if(dao.selectById(txtID.getText()) == null){
            try{
                dao.insert(kh);
                this.fillTable();
                this.clearForm();
    ...
    void clearForm(){
        ...
        this.row = -1;
        this.updateStatus();
        tblCustomer.setColumnSelectionInterval(0, 0);
    }
    void edit(){
        String makh = (String) tblCustomer.getValueAt(this.row, 0);
