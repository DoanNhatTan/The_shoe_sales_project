 ...
 */
public class ChuyenmanhinhIKh {

    private JPanel root;
    private String kindSelected = "";
    private java.util.List<DanhMucBeenImage> listItem = null;

    public ChuyenmanhinhIKh(JPanel jpnRoot) {
        this.root = jpnRoot;
    }
...
//        jlbItem.setBackground(new Color(33, 96, 196));
    ...
    public void Button(java.util.List<DanhMucBeenImage> listItem2, String kind) {
        ...
        switch (kind) {
            case "Main":
                no = new mainKhachHang();
                break;
            case "SP":
                no = new ChiTietSanPham();
                break;
            default:
                break;
        }
    ...
    class LabelEvent implements MouseListener {
        ...
        public void mouseClicked(MouseEvent e) {
            switch (kind) {
            case "Main":
                node = new mainKhachHang();
                break;
            case "SP":
                node = new ChiTietSanPham();
                break;
            default:
                break;
        }
